...
contract ERC404Marketplace is IERC721Receiver,Ownable {
    ...
    uint256 private tax = 1; // percentage
    mapping ( uint256 => ListDetail ) listDetail;

    constructor(IERC20 _token, IERC721Enumerable _nft, address initialOwner_) Ownable(initialOwner_) {
        nft = _nft;
        token = _token;
    }
