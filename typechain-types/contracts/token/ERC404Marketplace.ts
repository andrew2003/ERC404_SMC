...
export declare namespace ERC404Marketplace {
...
export interface ERC404MarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buyNft"
      | "getListedNft"
...
export interface ERC404Marketplace extends BaseContract {
  connect(runner?: ContractRunner | null): ERC404Marketplace;
  waitForDeployment(): Promise<this>;

  interface: ERC404MarketplaceInterface;
  ...
  getListedNft: TypedContractMethod<
    [],
    [ERC404Marketplace.ListDetailStructOutput[]],
    "view"
  >;
