...
export interface USDTWInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "allowance"
...
export interface USDTW extends BaseContract {
  connect(runner?: ContractRunner | null): USDTW;
  waitForDeployment(): Promise<this>;

  interface: USDTWInterface;
