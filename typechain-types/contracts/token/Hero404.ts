...
export interface Hero404Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "ID_ENCODING_PREFIX"
...
export interface Hero404 extends BaseContract {
  connect(runner?: ContractRunner | null): Hero404;
  waitForDeployment(): Promise<this>;

  interface: Hero404Interface;
