...
import type { ERC404U16, ERC404U16Interface } from "../../contracts/ERC404U16";
...
export class ERC404U16__factory {
  ...
  static createInterface(): ERC404U16Interface {
    return new Interface(_abi) as ERC404U16Interface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC404U16 {
    return new Contract(address, _abi, runner) as unknown as ERC404U16;
  }
}
