...
import type { ERC404, ERC404Interface } from "../../contracts/ERC404";
...
export class ERC404__factory {
  ...
  static createInterface(): ERC404Interface {
    return new Interface(_abi) as ERC404Interface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC404 {
    return new Contract(address, _abi, runner) as unknown as ERC404;
  }
}
